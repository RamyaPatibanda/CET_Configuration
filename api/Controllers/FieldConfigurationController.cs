...
namespace api.Controllers
{
    ...
    public class FieldConfigurationController : ControllerBase
    {
        ...
        public FieldConfigurationController(
            IFieldConfigurationBL businessLogic,
        ...
        public async Task<ActionResult<List<FieldDefinition>>> GetFields()
        {
            try
            {
                return Ok(await _businessLogic.GetFieldsAsync());
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Error while getting fields.");
                return StatusCode(500, new { message = "Unable to get fields." });
            }
        }
        ...
        public async Task<ActionResult<FieldDefinition>> GetField(int fieldId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Unable to get field." });
            }
        }
        ...
        public async Task<ActionResult<int>> CreateField([FromBody] CreateFieldRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Error while creating field.");
                return StatusCode(500, new { message = "Unable to create field." });
            }
        }
        ...
        public async Task<IActionResult> UpdateField(int fieldId, [FromBody] UpdateFieldRequest request)
        {
            ...
            {
                _logger.LogError(ex, "Error while updating field {FieldId}.", fieldId);
                return StatusCode(500, new { message = "Unable to update field." });
            }
        }
        ...
        public async Task<IActionResult> DeleteField(int fieldId)
        {
            ...
            catch (Exception ex)
            {
                ...
                return StatusCode(500, new { message = "Unable to delete field." });
            }
        }
    }
}
